...
-- Q4. Which rating is most prevalant in each store? --
...
-- Q5. List of films by Film Name, Category, Language --
...
-- Q6. How many times each movie has been rented out?
...
-- Q7. REVENUE PER FILM (TOP 10 GROSSERS)
...
-- Q8. Most Spending Customer so that we can send him/her rewards or debate points
...
-- Q9. Which Store has historically brought the most revenue?
...
-- Q10. How many rentals we have for each month
...
-- Q11. Reward users who have rented at least 30 times (with details of customers)
...
-- Q12. Could you pull all payments from our first 100 customers (based on customer ID)

SELECT CUSTOMER_ID,RENTAL_ID,AMOUNT,PAYMENT_DATE
FROM PAYMENT
WHERE CUSTOMER_ID<101;

-- Q13. Now I’d love to see just payments over $5 for those same customers, since January 1, 2006

SELECT CUSTOMER_ID,RENTAL_ID,AMOUNT,PAYMENT_DATE
FROM PAYMENT
WHERE CUSTOMER_ID<101 AND AMOUNT > 5 AND PAYMENT_DATE> '2006-01-01';

-- Q14. Now, could you please write a query to pull all payments from those specific customers, along
...
-- Q15. We need to understand the special features in our films. Could you pull a list of films which
...
-- Q16. unique movie ratings and number of movies

SELECT RATING,COUNT(FILM_ID) AS NUMBER_OF_FILMS
FROM FILM
GROUP BY RATING;

-- Q17. Could you please pull a count of titles sliced by rental duration?
...
-- Q18. RATING, COUNT_MOVIES,LENGTH OF MOVIES AND COMPARE WITH RENTAL DURATION
...
-- Q19. I’m wondering if we charge more for a rental when the replacement cost is higher.
...
-- Q20. “I’d like to talk to customers that have not rented much from us to understand if there is something
...
-- Q21. “I’d like to see if our longest films also tend to be our most expensive rentals.
...
-- Q22. CATEGORIZE MOVIES AS PER LENGTH
...
-- Q23. CATEGORIZING MOVIES TO RECOMMEND VARIOUS AGE GROUPS AND DEMOGRAPHIC
...
-- Q24. “I’d like to know which store each customer goes to, and whether or
...
-- Q25. “Can you pull for me a list of each film we have in inventory?
...
-- Q26. Actor first_name, last_name and number of movies
...
-- Q27. “One of our investors is interested in the films we carry and how many actors are listed for each
...
-- Q28. “Customers often ask which films their favorite actors appear in. It would be great to have a list of
...
-- Q29. “The Manager from Store 2 is working on expanding our film collection there.
...
-- Q30. “We will be hosting a meeting with all of our staff and advisors soon. Could you pull one list of all staff
